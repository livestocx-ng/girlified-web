...
export const metadata: Metadata = {
  ...
  description:
    "Stories of impact, innovation & community. Field insights, manufacturing milestones, partnerships, and the people powering women's health and sustainability across Africa.",
  keywords: [
    'Girlified',
    'Sanitary Pads',
    'Banana Stem Fiber',
